...
if($user != null) {
    $vertItems = [
        ['text' => 'Gérer client', 'url' => 'manageclient.php'],
        ['text' => 'Gérer projets', 'url' => 'manageprojets.php'],
        ['text' => 'Consulter clients', 'url' => 'detailsclients.php'],
        ['text' => 'Messages', 'url' => 'messages.php']
    ];
}
else {
    $vertItems = [];
