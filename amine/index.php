  ...
  <article id="top">
				<div class="nex-hello">
					<div class="row">
						...
						<div class="col-8">
							<header>
								<h1>Bienvenu dans    <strong>     N e x L a b</strong>.</h1>
							</header>
							<p>La celebre societe de la<strong style="color: white;"> TRANSFORMATION DIGITAL </strong>au monde.</p>
							<a href="signup.php" class="btn">Creer votre compte </a>
						</div>
					</div>
				</div>
	</article>
	...
	<article id="wwd">
	        	<center>	<h1 style="margin:0; padding-top:15px; height:70px; background-color:#34d989;">QU'EST CE QU'ON REALISE POUR NOS CHERE CLIENTS</h1></center>
		<div class="row">			 
		<div class="col-8">
						 				<div class="row wwd" style="border:2px solid black;">
											 			<div class="col-4" style="background:url('./assets/img/wwd/xweb-application-development.png.pagespeed.ic.NH1e09nZtT.jpg');background-size: cover;
    background-position: left;">
																				<h3>DÉVELOPPEMENT D'APPLICATIONS WEB</h3>
																				<p class="wwdp">
																			NEXLAB exploite les technologies les plus avancées pour fournir des applications Web de classe mondiale depuis 15 ans.
                                         Des applications cloud aux applications Web mobiles et périphériques connectés,
...
facilite la livraison de fonctionnalités ou d'informations sur Internet.
    ...
    background-position: center;">
																				<h3  style="color:white;">CONCEPTION D'EXPÉRIENCE UTILISATEUR - DESIGN UX</h3>
																				<p class="wwdp">
